...
PLAY_MOVE_TOOL = {
    ...
    "function": {
        "name": "play_move",
        "description": "Play a move in the active game using standard Universal Chess Interface (UCI) notation.",
        "parameters": {
            "type": "object",
            "properties": {
                "move": {
                    "type": "string",
                    "description": "The move to play in UCI notation (for example 'e2e4' or 'e7e8q').",
                }
            },
            "required": ["move"],
            "additionalProperties": False,
